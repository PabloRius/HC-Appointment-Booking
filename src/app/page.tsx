            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                ...
                {profile && !loading ? (
                  ...
                  <Button size="lg" disabled className="bg-gray-400 w-fit">
          ...
          <section id="features">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our platform offers a comprehensive suite of tools to manage
                your healthcare appointments efficiently.
              </p>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500">
                  Book appointments with just a few clicks and manage your
